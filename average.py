# Make a program that reads the grades of two tests, calculates the simple arithmetic mean,
# and informs whether the student passed (average greater than or equal to 6) or failed (average less than 6).
